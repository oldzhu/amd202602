"""
MoE-MXFP4: Deep buffer pre-allocation via monkey-patching.
Pre-allocates ALL internal buffers in fused_moe_2stages by patching
fused_dynamic_mxfp4_quant_moe_sort to reuse cached output tensors.
Also pre-allocates the a2 intermediate buffer.
"""
...
# Caches for internal buffers
_A2_CACHE = {}
_QUANT_FP4_CACHE = {}
_QUANT_SCALE_CACHE = {}

# Store original function
_orig_fused_dynamic_mxfp4_quant_moe_sort = _fmq.fused_dynamic_mxfp4_quant_moe_sort
...
def _patched_fused_dynamic_mxfp4_quant_moe_sort(
    ...
    """Patched version that reuses cached output buffers."""
    M, N = x.shape
...
_fmq.fused_dynamic_mxfp4_quant_moe_sort = _patched_fused_dynamic_mxfp4_quant_moe_sort
