"""
MXFP4-MM: 32x256 tile experiment
Uses wider N-tile (256 instead of 128) for better A-matrix data reuse.
"""
...
_ASM_KERNEL = "_ZN5aiter41f4gemm_bf16_per1x32Fp4_BpreShuffle_32x256E"
_TILE_M, _TILE_N, _TILE_K = 32, 256, 256
_CU_NUM = 304
