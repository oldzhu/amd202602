"""
Mixed-MLA: a16w8 approach - bf16 Q with fp8 KV.
Skips Q quantization entirely to save ~6-12μs overhead.
"""
...
# Per-shape optimal splits (same as current best)
_SPLIT_MAP = {
    (4, 1024): 12,
    (4, 8192): 16,
    (32, 1024): 16,
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use bf16 Q directly - no quantization needed for a16w8 path
