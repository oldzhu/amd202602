"""
Mixed-MLA: gran32 with higher splits for large shapes.
kv_granularity=32 was proven to give 30% improvement (52μs vs 74μs).
This variant tries higher splits for the large (256,8192) shape that dominates geomean.
"""
...
# More aggressive splits for gran32
# (256,8192) is 259μs = biggest bottleneck
_SPLIT_MAP = {
    (4, 1024): 12,
    (4, 8192): 20,    # was 16, try higher
    (32, 1024): 16,
    (32, 8192): 28,   # was 24, try higher
    (64, 1024): 20,   # was 16, try higher
    (64, 8192): 28,   # was 24, try higher
    (256, 1024): 24,  # was 20, try higher
    (256, 8192): 32,  # was 24, try max
}
