"""
Mixed-MLA: Bypass mla_decode_fwd + paged KV (page_size=16).
Calls stage1 ASM + reduce directly with pre-cached intermediate buffers.
Uses page_size=16 to reduce page table overhead.
"""
...
def _get_uniform_indptrs(batch_size, q_seq_len, kv_seq_len, device):
    num_pages_per_seq = kv_seq_len // PAGE_SIZE
