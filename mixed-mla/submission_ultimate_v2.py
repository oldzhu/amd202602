"""
Mixed-MLA: Ultimate combo — gran32 + a16w8 + high splits.
- kv_granularity=32 (30% improvement proven)
- bf16 Q with fp8 KV (skip Q quantization)
- Higher splits for large shapes
"""
...
# Aggressive split map for gran32
_SPLIT_MAP = {
    (4, 1024): 12,
    (4, 8192): 20,
    (32, 1024): 16,
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # a16w8: use bf16 Q directly, skip quantization
