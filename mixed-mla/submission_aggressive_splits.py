"""
Mixed-MLA: Aggressive split tuning - fewer splits for small batches
Tests 8 splits for (4,1024) and 12 for (4,8192), (32,1024)
"""
...
# Aggressive split tuning: fewer splits for small batches
_SPLIT_MAP = {
    (4, 1024): 8,        # Was 12 in splits_grid → try 8
    (4, 8192): 12,       # Was 16 → try 12
    (32, 1024): 12,      # Was 16 → try 12
    (32, 8192): 20,      # Was 24 → try 20
    (64, 1024): 12,      # Was 16 → try 12
    (64, 8192): 20,      # Was 24 → try 20
    (256, 1024): 16,     # Was 20 → try 16
    (256, 8192): 20,     # Was 24 → try 20
}
