"""
Mixed-MLA: Optimized wrapper approach with fast_mode=True and tuned splits.
Uses mla_decode_fwd wrapper (safer than direct ASM for leaderboard mode)
but with fast_mode=True and per-shape split optimization.
"""
...
PAGE_SIZE = 1
KV_GRANULARITY = 16  # Top entries use kvgran16
...
# Based on top leaderboard entry: s4 for 256 shapes, high splits for small batch
_SPLIT_MAP = {
    (4, 1024): 16,
    (4, 8192): 32,
    (32, 1024): 16,
