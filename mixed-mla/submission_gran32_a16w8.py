"""
Mixed-MLA: gran32 + a16w8 — best of both optimizations.
- kv_granularity=32 (30% improvement)
- bf16 Q with fp8 KV (skip Q quantization, save ~6-12μs)
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use bf16 Q directly — a16w8 path, no quantization
