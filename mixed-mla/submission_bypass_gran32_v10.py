"""
Mixed-MLA: Bypass + kv_granularity=32 + v1_0 scheduler (gfx950 heuristic).
Uses fast_mode=False, intra_batch_mode=True to pick the gfx950-specific
196-token-per-split heuristic instead of the generic v1_2 scheduler.
"""
