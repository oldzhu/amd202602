"""
Mixed-MLA: Bypass mla_decode_fwd + kv_granularity=32.
Combines two proven optimizations:
1. Direct stage1 ASM + reduce with pre-allocated intermediates (skip wrapper allocation)
2. kv_granularity=32 (30% improvement from reduced partial tile overhead)
"""
