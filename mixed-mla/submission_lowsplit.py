"""
Mixed-MLA: Direct ASM with aggressive low-split tuning for large batches.
Based on leaderboard analysis - top entries use s4 for batch=256 shapes to
reduce the reduction phase overhead.
"""
...
# Low splits for large batches to reduce reduction overhead
# Based on top leaderboard entry clues: s4 for 256, s16 for 64
_SPLIT_MAP = {
    (4, 1024): 4,
    (4, 8192): 8,
    (32, 1024): 8,
