"""
Mixed-MLA: Direct ASM with kvgran16 + fast_mode=True + optimized splits.
Based on top leaderboard entries - kvgran16 is used by 35.3μs entry,
combined with very low splits for batch=256 and moderate for others.
"""
...
PAGE_SIZE = 1
KV_GRANULARITY = 16  # Top entries use 16, not 32
...
# Split tuning matching top "structmix_hs" leaderboard pattern:
# highsplit (32) for small/medium batches, s16 for 64long, s4 for batch=256
_SPLIT_MAP = {
    (4, 1024): 32,
    (4, 8192): 32,
    (32, 1024): 32,
